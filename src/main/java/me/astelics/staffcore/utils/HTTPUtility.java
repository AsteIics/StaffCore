...
public class HTTPUtility {
    ...
    private Cache<String, String[]> cachedSkinResponses = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build();
    ...
    public void get(String url, JSONResponseCallback callback) {
